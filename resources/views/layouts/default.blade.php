    ...
    <header>
        <div class="container px-4 mx-auto">
            <nav class="flex items-center justify-between py-6">
                ...
                <div>
                    <a class="mr-2 inline-block px-4 py-3 text-xs text-blue-500 hover:text-blue-600 leading-none border border-blue-200 hover:border-blue-300 rounded" href="{{route('contact.index')}}">お問い合わせ</a>

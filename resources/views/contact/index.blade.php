    ...
    <div class="row bg-light text-dark py-5">
        <div class="col-md-8 offset-md-2">
            ...
            <form method="post" action="{{route('contact.sendMail')}}">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" name="address" placeholder="住所" value="">
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control" name="email" placeholder="メールアドレス（必須）" value="">
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control" name="phone" placeholder="電話番号" value="">
                </div>
                <div class="mb-4">
                    <textarea class="form-control" name="content" rows="5" placeholder="メッセージを入力してください"></textarea>
                </div>
